...
// Type: Crystallic.InvasionContent
...
namespace Crystallic
{
  public class InvasionContent : ContainerContent
  {
    ...
    {
      this.invasionComplete = invasionContent.invasionComplete;
    }
    ...
    {
      InvasionContent current = (InvasionContent) Player.local.creature.container.contents.Find((Predicate<ContainerContent>) (c => c is InvasionContent));
      if (current == null)
      {
    ...
    public virtual ContainerContent Clone() => (ContainerContent) new InvasionContent(this);
